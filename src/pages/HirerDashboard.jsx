...
const HirerDashboard = () => {
  ...
  return (
    <div style={{
      ...
      <h1 style={{ color: '#00B7B5', textShadow: '0 0 15px rgba(0, 183, 181, 0.4)', marginBottom: '10px' }}>
        Hirer Dashboard
      </h1>
      ...
      <div style={{
        ...
        <p style={{ margin: '20px 0', color: '#b0b0b0' }}>Post jobs and manage your candidates here.</p>
